    ...
    <div className="min-h-[85vh] flex">
      ...
      <div className="hidden md:block md:w-1/2 relative">
        ...
        <div className="absolute bottom-10 left-10 text-white">
          <h2 className="text-3xl font-serif font-bold tracking-widest drop-shadow-lg">
            E-SHOP.
          </h2>
          <p className="tracking-widest uppercase text-xs mt-2 drop-shadow-md">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8">
        <div className="w-full max-w-md">
          <div className="mb-12 text-center">
            <h2 className="text-3xl font-serif font-bold tracking-widest text-black mb-3 uppercase">
              Welcome Back
            </h2>
          ...
          <form onSubmit={handleLogin} className="space-y-10">
            ...
            <div className="relative">
              <input
                type="text" // ⚠️ Yahan humne 'email' ki jagah wapas 'text' kar diya hai
                id="email"
                ...
                placeholder="Email or Username" // ⚠️ Placeholder bhi update kar diya
                value={email}
            ...
            <div className="flex justify-end">
              <button
                type="button"
                className="text-[10px] text-gray-400 hover:text-black transition-colors uppercase tracking-[0.2em] font-bold border-b border-transparent hover:border-black pb-1"
              >
                Forgot Password?
              </button>
            </div>
          ...
          <div className="mt-16 text-center pt-8 border-t border-gray-50">
            <p className="text-gray-400 text-[10px] tracking-widest uppercase font-bold">
              ...
              <Link
                to="/register"
                className="text-black ml-2 hover:border-b border-black pb-1 transition-all"
              >
                Create Account
              </Link>
            </p>
